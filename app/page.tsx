...
export default function Home() {
  const [calendarRange, setCalendarRange] = useState({
    ...
    to: addDays(new Date("2024-01-01"), 20),
  });
          ...
          <div className="inline-flex flex-col  gap-[50px] relative ml-4">
            <div className="inline-flex justify-center items-center gap-[30px] relative">
              <div className="flex flex-col w-[669px] h-[642px] items-start gap-[11px] relative">
                <div className="relative w-[640px] h-[440px] bg-black rounded-[20px] border border-solid border-[#b2b2b2] z-10">
                  <MapContainer
                ...
                <div className="relative w-[640px] h-[183px] bg-black rounded-[15px] border border-solid border-[#bfbfbf]">
                  {" "}
                  <Card
                    className={`${
                  ...
                  >
                    <CardHeader>
                      <CardTitle
                        className={`flex items-center justify-center text-center text-sm md:text-base ${
              ...
              <div className="flex flex-wrap w-[677px] items-start gap-[10px_10px] relative -ml-12">
                <div
                  className={`relative w-[321px] h-[311px] ${
                    isDarkMode ? "bg-black" : "bg-white"
                  } rounded-[20px] ${
                    isDarkMode
            ...
            <div className="inline-flex flex-col items-start gap-[15px] relative flex-[0_0_auto] mr-8">
              <div className="inline-flex items-start gap-[12px] relative flex-[0_0_auto]">
                <div
                  className={`${
                    isDarkMode ? "bg-black" : "bg-white"
                  } relative w-[450px] h-[299px] rounded-[13.94px]`}
                >
                  <Card
                    className={`${
                      isDarkMode
